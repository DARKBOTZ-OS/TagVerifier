...
API_HASH = os.environ.get("API_HASH", "3cae53dab85eb231ce6095b3b92e9d86")
TOKEN = os.environ.get("TOKEN", None)
TAG = os.environ.get("TAG", None)
OWNER_ID = int(os.environ.get("OWNER_ID", 1830670820))
...
async def start(_, message):
   await message.reply("HAM ABHI JINDA HAI.")
